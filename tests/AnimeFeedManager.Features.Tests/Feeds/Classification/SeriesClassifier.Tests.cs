...
public class SeriesClassifierTests
{
    ...
    public void Should_Preserve_Previous_Platforms_When_Fresh_Read_Is_Empty()
    {
        ...
        var result = SeriesClassifier.Classify(1, ImmutableArray<JikanStreamingEntry>.Empty, previousPlatforms: previous);
    ...
    public void Should_Replace_Previous_Platforms_When_Fresh_Read_Has_Data()
    {
        ...
        var result = SeriesClassifier.Classify(1, platforms, previousPlatforms: previous);
