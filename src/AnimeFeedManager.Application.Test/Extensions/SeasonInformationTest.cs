...
public class SeasonInformationTest
{
    ...
    public void ShouldOrderSeasonInformation()
    {
        var seasons = new[]
        {
            new SeasonInformation(Season.Fall, Year.FromNumber(2019)),
            new SeasonInformation(Season.Spring, Year.FromNumber(2019)),
            new SeasonInformation(Season.Spring, Year.FromNumber(2018)),
            new SeasonInformation(Season.Summer, Year.FromNumber(2019)),
            new SeasonInformation(Season.Winter, Year.FromNumber(2019)),
            new SeasonInformation(Season.Winter, Year.FromNumber(2020))
        };
