...
internal static class MoviesMappers
{
    internal static MovieStorage ProjectToStorageModel(ShortAnimeInfo source)
    {
    ...
    internal static ImmutableList<MovieStorage> ProjectToStorageModel(ImmutableList<ShortAnimeInfo> source) =>
