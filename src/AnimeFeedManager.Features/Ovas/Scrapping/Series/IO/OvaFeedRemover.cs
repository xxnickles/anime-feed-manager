...
using OvasContainer =
    (System.Collections.Immutable.ImmutableList<
        AnimeFeedManager.Features.Ovas.Scrapping.Series.Types.Storage.OvaStorage> Ovas, Azure.Data.Tables.TableClient
    Client);
using OvaContainer =
    (AnimeFeedManager.Features.Ovas.Scrapping.Series.Types.Storage.OvaStorage Ova, Azure.Data.Tables.TableClient Client);
