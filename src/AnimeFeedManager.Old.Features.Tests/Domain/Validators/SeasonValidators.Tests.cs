...
namespace AnimeFeedManager.Old.Features.Tests.Domain.Validators;
    ...
    public void Should_Invalidate_Wrong_Inputs(string season, ushort year, string[] expectedErrorFields)
    {
        ...
        sut.Match(
            ...
            e =>
            {
                ...
                Assert.Equal(expectedErrorFields.Length, errors.Errors.Keys.Length());
                Assert.True(expectedErrorFields.All(errors.Errors.Keys.Contains));
            });
    }
